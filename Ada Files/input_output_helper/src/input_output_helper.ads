...
package Input_Output_Helper is
   ...
   function Get_Byte_From_Tensor
     (Data : in Word_Array; Index : Natural) return Unsigned_Byte;
   ...
   pragma Inline(R32);
   pragma Inline(Add_Byte_Offset);
   pragma Inline(Write_Reg);
   pragma Inline(Read_Reg);
   pragma Inline(Unpack_Byte_At_Index);
   pragma Inline(Get_Byte_From_Tensor);
   pragma Inline(Tensor_Words);
   pragma Inline(Float_To_Q07);
   pragma Inline(Q07_To_Float);
   pragma Inline(Int_To_Q07);
   pragma Inline(Q07_To_Int);
   pragma Inline(uint8_To_Q07);
